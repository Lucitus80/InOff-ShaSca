...
## v0.7.9 - Mikkyo Ki Cost Stability & Compact Create Buttons
...
## v0.7.9 - Technique/Mikkyo Creation & Ki Cost Display Fix
...
## v0.7.9 - Techniques & Mikkyo Clan/Rank Pass
...
- Old v0.7.9 `system.techniqueType` is still read as a compatibility fallback for existing Technique items.
...
Legacy fallback for older v0.7.9 items:
